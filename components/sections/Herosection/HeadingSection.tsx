...
export default function HeadingSection() {
    return (
        <section className="w-[85%] mx-auto flex flex-col items-center text-center mt-10">
            ...
            {/* Heading */}
            <h1
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight text-black px-2"
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-7 w-full sm:w-auto px-4 sm:px-0">
                ...
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-orange text-white px-6 py-2 rounded-md text-sm hover:scale-105 transition">
