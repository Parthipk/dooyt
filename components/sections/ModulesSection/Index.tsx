        ...
        {modules.map((mod: any) => {
          ...
          return (
            <button
              ...
              className={`group flex items-center gap-2 px-4 py-2 min-w-[160px]
                ...
                {Icon && (
                  <Icon
                    ...
                    className={`absolute transition ${
                      isActive ? "text-white" : "opacity-0 group-hover:opacity-100"
                    }`}
                  />
                )}
              </span>
      ...
      {active && (
        <div className="mx-auto bg-orange-50 rounded-l-3xl flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 px-6 md:px-10 pt-6 md:pt-10">
            <Image src={modulebg} alt="module" className="w-full h-auto" />
          </div>
